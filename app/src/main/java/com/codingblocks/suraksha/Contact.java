...
//            cardView=itemView.findViewById(R.id.cardview);
    ...
    class Adapter extends RecyclerView.Adapter<contactHolder>{
        ...
        public void onBindViewHolder(final contactHolder holder, final int position) {
            ...
            storeNumberToSharedPreferences(number); //storing emergency contact to sharedpreferenecs
    ...
    private void storeNumberToSharedPreferences(String number) {

        SharedPreferences.Editor editor = getSharedPreferences("ContactPreferences", MODE_PRIVATE).edit();
